...
$pwd = cwd();
$parent = "$pwd/Sym_Gene_Phylogenies/SymbioticProteinsOperons/";
$output1 = "$pwd/Sym_Gene_Phylogenies/SymbioticProteinsOperons_Mafft/";
$output2 = "$pwd/Sym_Gene_Phylogenies/SymbioticProteinsOperons_TrimAl/";
