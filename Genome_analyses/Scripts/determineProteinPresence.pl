...
# List of files
$strainFile = 'Input_lists/genomeList_sino.txt';
$nodA_file = 'Symbiotic_gene_presence/HMMscanTop/NodA.csv';
$nodB_file = 'Symbiotic_gene_presence/HMMscanTop/NodB.csv';
$nodC_file = 'Symbiotic_gene_presence/HMMscanTop/NodC.csv';
$nifH_file = 'Symbiotic_gene_presence/HMMscanTop/NifH.csv';
$nifD_file = 'Symbiotic_gene_presence/HMMscanTop/NifD.csv';
$nifK_file = 'Symbiotic_gene_presence/HMMscanTop/NifK.csv';
