...
# Input files
$nifH_file = 'Sym_Gene_Phylogenies/SymbioticProteins/NifH_all.faa';
$nifD_file = 'Sym_Gene_Phylogenies/SymbioticProteins/NifD_all.faa';
$nifK_file = 'Sym_Gene_Phylogenies/SymbioticProteins/NifK_all.faa';

# Output files
$nifH_out_file = 'Sym_Gene_Phylogenies/SymbioticProteinsOperons/NifH.faa';
$nifD_out_file = 'Sym_Gene_Phylogenies/SymbioticProteinsOperons/NifD.faa';
$nifK_out_file = 'Sym_Gene_Phylogenies/SymbioticProteinsOperons/NifK.faa';

# Collect all NifH proteins
open($in, '<', $nifH_file);
while(<$in>) {
    chomp;
    @line = split("\t", $_);
