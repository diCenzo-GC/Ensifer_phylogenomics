...
# set variables
$pwd = cwd();
$parent = "$pwd/Sym_Gene_Phylogenies/SymbioticProteinsOperons_TrimAlmodified_Rep/";
$species_list = "Sym_Gene_Phylogenies/SymbioticProteinsOperons_TrimAlmodified_Rep/RepA_trimal.fasta";
