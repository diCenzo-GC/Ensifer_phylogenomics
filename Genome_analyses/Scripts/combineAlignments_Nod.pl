...
# set variables
$pwd = cwd();
$parent = "$pwd/Sym_Gene_Phylogenies/SymbioticProteinsOperons_TrimAlmodified_Nod/";
$species_list = "Sym_Gene_Phylogenies/SymbioticProteinsOperons_TrimAlmodified_Nod/NodA_trimal.fasta";
